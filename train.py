...
if __name__ == '__main__':
    ...
    parser.add_argument('--feat_dropout', type=float, default=0.0, help='dropout for neural networks.')
    parser.add_argument('--prop_dropout', type=float, default=0.5, help='dropout for neural networks.')
